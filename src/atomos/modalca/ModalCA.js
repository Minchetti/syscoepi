...
class ModalCA extends React.Component {
  ...
  componentDidMount(){   
    html2canvas(document.getElementById("gerar")).then(canvas => {
      ...
      <div onClick={this.teste}>AQUI</div>
              ...
              <div className="modal-body">
                ...
                <div style={{display: "block"}}>                
                  <div id="gerar" style={{width: "595px", height: "842px", padding: "55px 35px 55px 35px", background:"white", border: "0.1px solid black", margin: "auto"}}>
              ...
              {/* <div id="gerar_aqui2" style={{width: "595px", height: "842px", padding: "55px 35px 55px 35px", background:"white", border: "0.1px solid black", margin: "auto"}}>
              </div> */}

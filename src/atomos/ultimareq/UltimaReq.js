...
<div className={props.size}>
  ...
  <div className={'UltimaReq panel ' + props.small}>
    <div className="panel-heading">
      <h5 className="text-left mb-0"><i className="fa fa-check-square-o pr-10" aria-hidden="true"></i>Ultimas Requisições  </h5>
    </div>
  ...
  <div className={'UltimaReq panel ' + props.big}>
    <div className="panel-heading">
      <h5 className="text-left mb-0"><i className="fa fa-check-square-o pr-10" aria-hidden="true"></i>Últimas Requisições</h5>
    </div>
    <div className="panel-body">
      <table className="table m-0">
        <thead className="thead-dark">

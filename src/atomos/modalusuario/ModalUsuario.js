...
class ModalUsuario extends React.Component {
  ...
  CarregarDadosConta = () => {        
    ...
    // });
    var data = [
      {celular: '', codigoAtividade: '', website: '', cep: '', estado: '', cidade: '', bairro: '', rua: '', numero: '', senha: '', confirmaSenha: '', cnpj: '12345678998765', nomeAmigavel:'Empresa 1', razaoSocial: 'Razao1', nome: 'Marcello', cpf: '10770546617', email: 'minchettimarcello@gmail.com'} 
    ]
  ...
  onChange = () =>{
    ...
    {
      document.getElementById("editarConta").parentNode.style.display = "block";
    }
    else{
        ...
        <div className="modal fade" id="modal-usuario" tabIndex="-1" role="dialog" aria-labelledby="modal-usuario-label" aria-hidden="true">
          <div className="modal-dialog  modal-lg" role="document">
            <div className="modal-content text-dark z-9999">
              ...
              <div className="modal-body "><div onClick={this.Teste}>AQUI</div>
                <form id="form-usuario" onSubmit={this.onSubmit} onChange={this.onChange} className="text-left d-flex flex-wrap" method="post" action="" data-toggle="validator" role="form">
                  ...
                  <div className="form-group col-md-3">
                    ...
                    <input type="text" value={this.state.estado} onChange={e => this.setState({ estado: e.target.value })} className="form-control" id="conta-estado" name="conta-estado" aria-describedby="estadoHelp" required />
                  </div>
                  <div className="form-group col-md-3">
                  ...
                  <div className="form-group mb-0 d-nonin">
                    ...
                    <button onClick={this.EditarConta} id="editarConta" type="submit" className="btn btn-primary" disabled>

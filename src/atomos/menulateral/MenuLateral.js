...
const MenuLateral = props => (
  // <span>{props.text}</span>
        ...
        <div className="nav-side-menu p-fixed">
          <div className="brand">
            <a id="menu-toggle" href="#" className="d-flex justify-content-between align-center pl-2 pr-20">Menu
          ...
          {/* <i className="fa fa-bars fa-2x toggle-btn" data-toggle="collapse" data-target="#menu-content"></i> */}
            ...
            <div className="menu-list">      
              <ul id="menu-content" className="menu-content collapse out">
                <li>
                  <a href="#" className="dashboard p-relative d-flex justify-content-between align-center pl-2 pr-20">
                    Dashboard <i className="fa fa-dashboard fa-lg"></i> 
                  </a>
                </li>

                <li>
                  <a href="#" className="request p-relative d-flex justify-content-between align-center pl-2 pr-20">
                ...
                <li>
                  <a href="#" className="company p-relative d-flex justify-content-between align-center pl-2 pr-20">
                ...
                <li data-toggle="collapse" data-target="#service" className="collapsed">
                  <a href="#" className="p-relative d-flex justify-content-between align-center pl-2 pr-20">
